...
### **Laboratorio**  
Sebbene non vi siano esperimenti di laboratorio riservati al Capitolo 8, molti studenti si divertiranno a casa a far crescere cristalli: incoraggiateli in questo senso. *Crystals and crystal growing* di Alan Holden e Phylis Singer è un'eccellente descrizione generale dei cristalli e delle loro caratteristiche e fornisce una quantità di informazioni particolari sull'accrescimento controllato dei cristalli. Questo libro fa parte della *Science Study Series*.

### **Lavori per casa, scuola e laboratorio**  
La seguente tabella classifica i problemi secondo la stima del loro grado di difficoltà e secondo i paragrafi cui si riferiscono. Sono indicati quelli particolarmente adatti ad una discussione in classe. I problemi particolarmente raccomandati sono contrassegnati da un asterisco (\*). Le soluzioni dei problemi sono date nelle pagine verdi: le risposte brevi a pagina 8-7; i commenti e le soluzioni dettagliate nelle pagine da 8-8 a 8-15.
...
È un affascinante documentario sulla natura dei cristalli, che descrive come questi si formino e spiega perché assumano determinate forme. Riprende realmente la crescita di un cristallo sotto un microscopio e dà istruzioni pratiche per l'accrescimento di cristalli.  
I fenomeni riguardanti i cristalli sono posti in relazione diretta con il concetto di atomo.  
**Durata della proiezione**: 25 minuti.

È in preparazione un film dal titolo *«Molecules»* (*Molecole*).
...
Una grammomolecola di qualunque gas, alla pressione atmosferica e a 0°C, occupa 22,4 litri ed ha una massa in grammi espressa da un numero uguale alla **massa molecolare** della molecola di gas (uguale alla massa atomica solo per i gas nobili monovalenti).
...
#### **Composti e miscugli**  
Nella maggioranza dei casi, la distinzione tra composti e miscugli è chiara. A volte tuttavia, stabilire con precisione se una data sostanza sia un «composto» o un «miscuglio» può essere tutt'altro che semplice.  
Prima di tutto, è molto difficile ottenere un campione assolutamente puro di qualsiasi sostanza. Impurità di una parte su un milione, o meno, spesso non sono eliminabili.

La maggior parte dei metalli di uso comune sono miscugli anziché elementi o composti.  
Esiste una grande varietà di acciai, ciascuno dei quali ha, mescolata con il ferro, una certa quantità di carbone insieme ad altri elementi come manganese, cobalto, nichel, ecc.  
L'ottone è rame e zinco, il duralluminio è alluminio e rame, l'oro «14 carati» contiene oro ed argento, il bronzo è rame e stagno, la lega per saldare è stagno e piombo.  
La composizione di molti metalli può cambiare senza che cambi il nome. Le proprietà fisiche delle leghe variano in modo abbastanza regolare con la composizione.

Citiamo soprattutto le leghe perché gli studenti difficilmente incontreranno un elemento metallico puro nella vita di ogni giorno; l'unica comune eccezione è il rame, che è spesso usato allo stato puro per collegamenti elettrici.  
La ragione principale per cui i metalli puri non si usano è che essi sono di solito meccanicamente molto deboli.  
L'aggiunta di altri elementi per formare delle leghe aumenta la resistenza meccanica. Però l'aggiunta di altri elementi aumenta anche la resistività elettrica, il che spiega perché il rame puro sia largamente usato.  
...
### Tabella: Composti di azoto ed ossigeno

| **Formula chimica** | **Nome**                 | **Stato a 20°C** | **Caratteristiche del gas**        | **Punto di ebollizione (°C)** | **Caratteristiche del liquido**    | **Punto di fusione (°C)** | **Caratteristiche del solido**       | **Note** |
|---------------------|--------------------------|------------------|------------------------------------|-------------------------------|-------------------------------------|----------------------------|---------------------------------------|---------|
| N₂O                 | Protossido di azoto      | gassoso          | incolore; 1,98 g/L                 | -89,5                         | incolore; 1,23 g/cm³                | -102,4                    | incolore; cristalli cubici           | Sotto pressione diventa pastoso; quando lo si rilascia, forma delle bolle, come panna montata. È il "gas esilarante", di uso generale come anestetico. |
| NO                  | Ossido di azoto          | gassoso          | incolore; 1,34 g/L                 | -151,8                        | blu; 1,27 g/cm³                     | -163,6                    | blu                                   | Prodotto per riduzione di acido nitrico diluito (6 normale) con Cu o Hg. $3 \text{Cu} + 8 \text{H}^+ + 2 \text{NO}_3^- \rightarrow 3 \text{Cu}^{2+} + 4 \text{H}_2\text{O} + 2 \text{NO}$. Nella stessa reazione vengono prodotti N₂ e NO₂. |
| N₂O₃               | Anidride nitrosa         | gassoso          | rosso-bruno                        | 3,5                           | azzurro cupo                        | -102                      | blu                                   | Si può formare raffreddando una miscela di NO ed NO₂. Sciolto in H₂O, forma acido nitroso: $N_2O_3 + H_2O \rightarrow 2HNO_2$. |
| NO₂                 | Biossido d'azoto         | liquido          | rosso                              | 21,3                          | –                                   | -9,3                      | –                                     | NO₂ ed N₂O₄ esistono sempre in equilibrio: si possono formare da HNO₃ concentrato e Cu. |
| N₂O₄               | Ipoazotide               | liquido          | incolore                           | 21,3                          | –                                   | -9,3                      | –                                     | NO₂ ed N₂O₄ esistono sempre in equilibrio: si possono formare da HNO₃ concentrato e Cu. |
| N₂O₅               | Anidride nitrica         | solido           | si decompone                       | 47                            | –                                   | 30                        | cristalli bianchi                     | Si forma disidratando HNO₃ con P₂O₅; o ossidando NO₂ con ozono. |
...
a. Gli atomi di un elemento hanno lo stesso comportamento chimico e (quasi) lo stesso spettro ottico; essi possono avere masse differenti: in questo caso si chiamano **isotopi differenti**.

b. Qualsiasi materia può essere scomposta fino all'elemento idrogeno.  
L'idrogeno stesso consiste di una coppia di unità naturali: un **protone** ed un **elettrone**. Tutta la materia contiene un elettrone per ogni protone.

c. La **massa** è un conteggio del numero di **unità idrogenoidi** in cui una porzione qualsiasi di materia può alla fine essere scomposta.

### PUNTI DA METTERE IN EVIDENZA

Gli studenti incontreranno di nuovo i concetti di questi paragrafi nella Parte IV, dopo che avranno studiato le cariche elettriche.  
Se il tempo stringe, potete rimandare la discussione in classe.  
Comunque, questa materia costituisce il culmine logico del quadro atomico a questo livello.  
Gli atomi sono i blocchi elementari costitutivi della materia, e le *unità idrogenoidi* sono i blocchi elementari degli atomi.  
Inoltre, gli studenti vi faranno molte domande (ma voi rispondete solo ad alcune).  
Perciò dovrete dedicare un po' di tempo in classe a questi argomenti.

### COMMENTO

#### **Quadro semplificato degli atomi e degli elementi**  
La discussione sulle unità idrogenoidi come blocchi elementari apre la via ad una semplice ed accurata descrizione degli atomi e degli elementi, sebbene questa materia sia trattata nella Parte IV.

Un atomo è un **nucleo atomico** circondato da un numero di **elettroni** esattamente uguale al numero di **protoni** del nucleo.  
Le reazioni chimiche implicano una suddivisione ed un riassestamento degli elettroni più esterni.  
Per questa ragione gli atomi che hanno lo stesso numero di elettroni (e quindi di protoni) hanno le stesse proprietà chimiche, e perciò appartengono allo stesso **elemento**.

Gli **isotopi** dello stesso elemento differiscono solo per il numero di **neutroni** nel nucleo.  
(Il neutrone è simile ad un elettrone ed un protone strettamente accoppiati.)

La **massa** di un qualunque isotopo isolato, espressa in unità atomiche di massa, è quasi esattamente uguale ad un **numero intero**.  
Questo numero è la **somma dei neutroni e dei protoni** del nucleo.  
Per semplicità, il testo assegna un'unità idrogenoide sia al neutrone che al protone.  
Dato che il numero di unità idrogenoidi è (entro l'1%) uguale alla massa atomica, un conteggio delle unità idrogenoidi è una **misura della materia** che si potrebbe usare invece della massa.

Infatti, dato che queste unità sono blocchi elementari, sono una **misura base della materia**.  
(Quando la massa atomica di un elemento differisce di più dell'1% da un numero intero, questa discrepanza è sempre dovuta ad una **miscela di isotopi**.)

#### Note supplementari sulla fisica nucleare

Sebbene non sia certamente questo il momento di discutere questioni particolari di fisica nucleare, il materiale dell'**Appendice 2**, alla fine del volume, può aiutarvi a rispondere alle domande degli studenti.  
Le informazioni dell'appendice non sono destinate alla classe.  
Piuttosto che rischiare di confondere le idee agli studenti, sarebbe meglio rispondere *fuori lezione* alle domande che vertono su questa materia.
...
a. Le caratteristiche fisiche e chimiche delle molecole sono legate non solo all'identità ed al numero degli atomi presenti, ma anche alla **disposizione fisica** degli atomi.

b. Le **molecole organiche**, specialmente quelle che si incontrano nei sistemi viventi, sono spesso di grande complessità. Anch'esse però, come le più semplici, sono costituite di **atomi**, e la loro **struttura è la chiave** del loro comportamento.

### PUNTI DA METTERE IN EVIDENZA

Sebbene la materia sia di grande interesse, sarà bene trattarla al livello del testo, senza approfondire ulteriormente.  
Potete assegnarla come lettura per casa.

### COMMENTO

Vi consigliamo di includere *The Physics and Chemistry of Life* (un libro della serie *Scientific American*, pubblicato da Simon & Schuster, New York, 1955) nella biblioteca di classe.  
Nella bibliografia troverete molte opere di consultazione.  
Altri articoli interessanti appaiono continuamente nello *Scientific American* ed in altre riviste.  
*The Physical Solution of Biological Problems* è uno dei titoli in programma della *Science Study Series*.
...
a. Quando gli atomi o le molecole sono al loro posto in un **cristallo solido**, le molecole e talvolta perfino gli atomi cominciano a perdere la loro individualità.

b. La maggior parte dei **solidi** ha strutture **cristalline** ben determinate.

c. Le forme eleganti dei cristalli, e la loro particolare **geometria**, dipendono dal modo in cui i singoli atomi di un cristallo o di una molecola si dispongono;  
la disposizione **geometrica** (e non la forma dei singoli atomi) determina la **forma macroscopica** del cristallo.

d. Molte **proprietà fisiche** sono legate alla **struttura cristallina** (o alle sue imperfezioni).

### PUNTI DA METTERE IN EVIDENZA

Il testo si occuperà a fondo dell'argomento: non occorrerà quindi molto tempo in classe per chiarire le idee.  
Sarà più utile **osservare i cristalli**, **sezionarli** e **farli crescere**, anziché parlarne.

Se vi è possibile, mostrate agli studenti il film *«Crystals»* (*Cristalli*) di **Alan Holden** (25 minuti).  
Invitate i vostri allievi a **far crescere dei cristalli**, come suggerisce la monografia della *Science Study Series* *«Crystals and Crystal Growing»* di **Alan Holden** e **Phylis Singer**.
