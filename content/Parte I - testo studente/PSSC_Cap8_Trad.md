...
![Figura 1: Simboli di Dalton per alcuni elementi e composti, tra cui la sua formula per l'acqua (HO), oggi riconosciuta come errata.](Figure/Fig_8_01.png)
...
![Figura 2: Due volumi di vapore di HCl producono un volume di gas idrogeno e un volume di gas cloro, alle condizioni originarie di temperatura e pressione.](Figure/Fig_8_02.png)
...
![Figura 3: Un modello di una molecola di zucchero. È rappresentato uno dei molti zuccheri esistenti. Questo zucchero particolare corrisponde a $CH_2O_6$. Al centro si vedono gli atomi scuri di carbonio, legati ad atomi più chiari di idrogeno e ad atomi più grandi di ossigeno. I diametri atomici rappresentati sono dell’ordine di $10^{-2}$ m. I colori sono arbitrari.](Figure/Fig_8_03.png)
...
![Figura 4: Le molecole di butano e isobutano hanno entrambe quattro atomi di carbonio e dieci di idrogeno, ma strutture differenti, che le rendono composti diversi con proprietà distinte. L’alcol etilico e l’etere dimetilico hanno anch’essi gli stessi atomi nelle stesse proporzioni, ma sono composti diversi. Tali coppie sono dette “isomeri”.](Figure/Fig_8_04.png)
...
![Figura 5: Struttura delle molecole di acido stearico (sopra) e acido acetico (sotto). All’estremità sinistra dell’acido stearico, un atomo di carbonio (nero) è circondato da tre atomi di idrogeno (bianchi). Proseguendo verso destra dal gruppo $CH_3$, si estende una catena di gruppi $CH_2$ — atomi di carbonio circondati ciascuno da due atomi di idrogeno. A destra, la catena termina in un gruppo $COOH$. I due gruppi finali sono direttamente legati tra loro.](Figure/Fig_8_05.png)

![Figura 6: Modelli molecolari di acqua (a sinistra) e ossigeno (a destra).](Figure/Fig_8_06.png)
...
![Figura 7a: Il modello mostra una piccola sezione di una lunga molecola proteica. In questo modello, alto quasi un metro, gli emisferi chiari rappresentano atomi di idrogeno, che in realtà hanno un diametro di circa un ångström ($10^{-10}$ m).](Figure/Fig_8_07a.png)
...
![Figura 7b: Il diagramma mostra le dimensioni relative, le posizioni e i legami degli atomi che compongono una complicata molecola proteica. I simboli C, N e O rappresentano atomi di carbonio, azoto e ossigeno; i piccoli cerchi non etichettati rappresentano atomi di idrogeno che uniscono la struttura a forma di elica. Il simbolo R indica altre strutture connesse. In che direzione ruota questa elica? (Per gentile concessione di Linus Pauling e R. B. Corey).](Figure/Fig_8_07b.png)

![Figura 8: Nel cloruro di sodio, ogni atomo di sodio (più piccolo) è circondato da atomi di cloro (più grandi), e ogni atomo di cloro è circondato da atomi di sodio. È possibile determinare quale coppia specifica di atomi costituisca una molecola di cloruro di sodio?](Figure/Fig_8_08.png)

![Figura 9: Un grande gruppo di cristalli di gesso provenienti da una miniera di piombo in Messico. Il gruppo supera il metro d’altezza, ma anche il più piccolo frammento di gesso osservato al microscopio mostra la stessa struttura cristallina. In laboratorio, strutture analoghe possono essere prodotte dall’uomo in condizioni adeguate e con tempo sufficiente.](Figure/Fig_8_09.png)

![Figura 10: Cristalli di bromuro di sodio. Cristalli simili, ben formati, possono svilupparsi in pochi giorni in un luogo freddo della casa, come il frigorifero. Questi sono tetraedri regolari, cresciuti su un germe cristallino legato a un filo.](Figure/Fig_8_10.png)
...
![Figura 12: Fotografia (ingrandimento 6,5X) di un pezzo di zinco. Il gruppo di cristalli a ventaglio spicca chiaramente grazie alla rugosità naturale del campione, che lo pone leggermente al di sopra del resto del materiale. La forma cristallina di base non è visibile nelle aree più scure, poiché si trovano su piani differenti. Questa è solo una possibile illustrazione del fatto che i metalli si presentano come cristalli.](Figure/Fig_8_12.png)
...
![Figura 13: Cristalli romboedrici di spatò d’Islanda, una varietà trasparente di calcite, che mostrano i piani di clivaggio.](Figure/Fig_8_13.png)
...
![Figura 14: Diagramma di Haüy della struttura cristallina. Piccole forme geometriche identiche possono essere impilate per formare un modello di qualsiasi cristallo. Solo angoli che derivano da blocchi interi sono presenti.](Figure/Fig_8_14.png)

![Figura 15: La forma dei cristalli è determinata dalla disposizione relativa delle unità cristalline. I lati del cristallo derivano da combinazioni di vettori A e B tra unità adiacenti.](Figure/Fig_8_15.png)
...
![Figura 16: Proteina del capello. Le proteine fibrose, come i capelli e i muscoli, sono rappresentate dalla struttura mostrata sopra. Ogni molecola è rappresentata come una singola fibra composta da una doppia elica centrale e sei eliche laterali destrorse.](Figure/Fig_8_16.png)

![Figura 17: In alto, struttura del diamante, la sostanza più dura conosciuta. In basso, struttura del grafite. Entrambe sono forme del carbonio. Nel diamante gli atomi sono impacchettati; nel grafite formano strati distanziati che possono scivolare.](Figure/Fig_8_17.png)
