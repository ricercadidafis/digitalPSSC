...
![Figura 1: L’ingrandimento (in alto a destra) di una piccola sezione (al centro) della fotografia in bianco e nero mostra che l’immagine stampata è composta da punti neri. Più grandi sono i punti, più l’immagine appare nera. Più piccoli sono i punti, più si avvicina al bianco. L’ingrandimento è di circa 10 volte.](Figure/Fig_10_01.png)
...
![Figura 2: La decisione nella misura. I disegni sottostanti illustrano le prime decisioni prese nella più semplice delle misurazioni. Quanto maggiore è la serie, tanto più precisa sarà la misura che si sta effettuando.](Figure/Fig_10_02.png)
...
![Figura 5: Una scatola nera meccanico-ottica. L’illustrazione fornisce poca idea di cosa sia lo strumento, e ancora meno di come funzioni. Una vista interna è mostrata nella Fig. 7 — 3. Si tratta di una microbilancia a fibra di quarzo con la sua copertura montata. Qui è mostrato lo strumento così come viene utilizzato.](Figure/Fig_10_05.png)

![Figura 6: Calibrazione. Si può usare un oggetto di dimensioni note per calibrare una scatola nera. La reticella di diffrazione (ingrandita a sinistra) è stata graduata con 15.000 linee per pollice, facendo avanzare una vite di 1/15.000 di pollice mentre si marcava la superficie. Possiamo usare questa reticella per calibrare il microscopio elettronico, con il quale è stata fatta la fotografia ingrandita.](Figure/Fig_10_06.png)

![Figura 7: Interazione. In qualsiasi misura si tenti, l’operazione implica una certa interazione con ciò che si misura. Quanto più piccolo è l’oggetto da misurare, tanto più evidente è l’effetto dell’interazione. Quando si verifica la pressione dell’aria in uno pneumatico da bicicletta, l’interazione non è trascurabile. Ogni volta che si applica il manometro alla valvola, esce un po’ d’aria. Dopo alcune applicazioni, la pressione nello pneumatico si è ridotta sensibilmente.](Figure/Fig_10_07.png)
