...
![Figura 2: Molecole di ossigeno in un recipiente. Un piccolo cubo di spazio è stato ampliato di milioni di volte per mostrare cosa potremmo aspettarci di trovare in tale volume. È possibile che, scegliendo casualmente altri volumi identici, si trovi un numero maggiore o minore di molecole nei vari cubi. Tuttavia, è più probabile trovarne 3, come mostrato in figura. A destra è mostrata un’ampliazione di una delle molecole.](Figure/Fig_9_02.png)
...
![Figura 3: Il moto incessante delle molecole di un gas non solo causa urti tra le molecole stesse, ma anche collisioni contro le pareti del recipiente. La spinta esercitata da queste molecole sulle pareti costituisce la pressione del gas.](Figure/Fig_9_03.png)

![Figura 4: La pressione è la forza per unità di superficie. Il pistone a sinistra ha un’area quattro volte maggiore rispetto a quello a destra. Sebbene entrambi siano soggetti alla stessa pressione gassosa, il pistone sinistro sostiene una massa quattro volte maggiore, poiché un numero quadruplo di molecole lo colpisce ogni secondo. La stessa massa è quindi sostenuta per unità di area.](Figure/Fig_9_04.png)
...
![Figura 5: Apparecchio per studiare la pressione di un gas. Quando la valvola è aperta, il livello del mercurio è uguale in entrambi i lati del tubo. Possiamo introdurre un numero definito di molecole nello spazio $V_1$ attraverso il tubo a destra.](Figure/Fig_9_05.png)

![Figura 6: Aggiungiamo ulteriori molecole allo spazio $V_1$ e chiudiamo la valvola. La colonna di mercurio si alza a sinistra, misurando la pressione aggiuntiva.](Figure/Fig_9_06.png)
...
![Figura 7: Pressione aggiuntiva in funzione del numero di molecole per unità di volume, alla temperatura di fusione del ghiaccio.](Figure/Fig_9_07.png)
...
![Figura 8: Apparecchio per dimostrare la legge di Boyle. Man mano che si aggiungono libri (masse) sulla piattaforma, l’aria viene compressa nel cilindro e l’altezza della colonna d’aria diminuisce. Il numero di libri usati serve da misura della pressione, mentre l’altezza della colonna d’aria indica il volume.](Figure/Fig_9_08.png)

![Figura 9: Curva della legge di Boyle. I valori riportati sono stati ottenuti con l’apparecchio della Fig. 9-8. Anche in assenza di massa sulla piattaforma, $N/V$ non si annulla, poiché agisce ancora la pressione atmosferica.](Figure/Fig_9_09.png)
...
![Figura 10: Relazione tra la scala fondamentale di temperatura, la scala Kelvin e la scala centigrada (o Celsius).](Figure/Fig_9_10.png)
...
![Figura 12: Moto browniano. Immagine del moto irregolare di una particella, ottenuta con fotografie successive scattate ogni 20 secondi. In ciascun intervallo la particella si è spostata da un punto al successivo. Tra due scatti consecutivi può aver compiuto un percorso erratico simile alla traiettoria completa mostrata.](Figure/Fig_9_12.png)
...
![Figura 14a: Dimostrazione di un altro caso di moto browniano. La luce della sorgente è focalizzata su uno specchio sospeso liberamente in una camera protetta. Ogni movimento dello specchio provoca lo spostamento dell'immagine riflessa sul film di una camera. Mentre il film avanza, l'immagine riflessa genera una traccia ondulata, dimostrando che lo specchio ruota lentamente. Sotto sono mostrati tracciati tipici.](Figure/Fig_9_14a.png)

![Figura 14b: Durante questa esposizione, la pressione nella camera era pari alla pressione atmosferica.](Figure/Fig_9_14b.png)

![Figura 14c: Questo tracciato è stato ottenuto in condizioni simili alla (b), tranne che la pressione nella camera è stata ridotta a circa $1 \times 10^{-1}$ della pressione atmosferica (sufficiente a sostenere una colonna di mercurio alta $4 \times 10^{-2}$ mm). L’effetto delle collisioni molecolari è in questo caso molto più evidente.](Figure/Fig_9_14c.png)
...
![Figura 15: La Grande Nube di Magellano. Questa galassia satellite della Via Lattea si trova a una distanza di $1{,}75 \times 10^5$ anni luce dalla Terra. È simile, per natura, a un gas non confinato da pareti. Le stelle rappresentano gli atomi del “gas”, sebbene tra le stelle vi siano realmente anche atomi di gas ordinario.](Figure/Fig_9_15.png)
...
![Figura 16: Per il problema 10.](Figure/Fig_9_16.png)
...
![Figura 17: Per il problema 22.](Figure/Fig_9_17.png)
